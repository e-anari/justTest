@component('layouts.content')
        ...
        <div class="col-md-12 col-sm-12 ">
            <div class="x_panel">
                <div class="x_title">
                    <h2>User Report <small>show</small></h2>
                ...
                <div class="x_content">
                    <div class="col-md-3 col-sm-3  profile_left">
                        <div class="profile_img">
                            <div id="crop-avatar">
                                <!-- Current avatar -->
                                <img class="img-responsive avatar-view" src="/website-theme/images/picture.jpg"
                        ...
                        <ul class="list-unstyled user_data">
                            ...
                            @if ($user->country)
                            <li><i class="fa fa-map-marker user-profile-icon"></i>{{$user->country}}</li>
                            @endif

                            @if ($user->job)
                            <li><i class="fa fa-briefcase user-profile-icon"></i>{{$user->job}}</li>
                            @endif
                        </ul>

                        <a href="{{ route('profile.edit',$user)}}" class="btn btn-success"><i class="fa fa-edit m-right-xs"></i>Edit Profile</a>
                        <br />
