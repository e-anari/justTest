                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-6">
                                        <div id="datatable-responsive_filter" class="col-sm-9 dataTables_filter" style="float: right">
                                            ...
                                            <button onclick="window.location='{{ route('role.create') }}'" type="button" class="btn btn-info btn-lg">Add New</button>
                                        </div>
                                    </div>
                            </form>
                        </div>
                                ...
                                <table id="datatable-responsive"
                                    ...
                                    <tbody>
                                        ...
                                        <tr role="row" class="odd">
                                            ...
                                            <td class="d-flex">
                                                <button
                                                    onclick="window.location='{{ route('role.edit',$role) }}'"
                        ...
                        <div class="row">
                            <div class="col-sm-5">
                                <div class="dataTables_info" id="datatable-responsive_info" role="status"
                                    aria-live="polite">Showing {{$roles->firstItem()}} to
                                    {{$roles->lastItem()}} of
                                    {{$roles->total()}} entries</div>
                            </div>
                            <div class="col-sm-7">
                                {{-- pagination part --}}
